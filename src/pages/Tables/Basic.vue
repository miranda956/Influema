<template>
  <div class="tables-basic">
    <h2 class="page-title">Brands <span class="fw-semi-bold"></span></h2>
        
        <router-link  to="/app/components/newshop">
        
                <button type="button" class="btn btn-primary">On-Board Brand</button>
</router-link>

    <b-row>
      <b-col>
        <Widget
          title="<h5>Brands <span class='fw-semi-bold'></span></h5>"
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>Picture</th>
                  <th>Brand Name</th>
                  <th class="hidden-sm-down">website </th>
                  <th class="hidden-sm-down">Contact Name</th>
                  <th class="hidden-sm-down">Contact Mail</th>
